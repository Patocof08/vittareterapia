    ...
    <div className="min-h-screen flex flex-col" style={{ background: "#FAFAF8" }}>
      ...
      <div className="flex-1 container mx-auto px-4 md:px-6 py-20">
        <div className="max-w-3xl mx-auto">
          ...
          <h1 className="font-erstoria text-[clamp(2rem,5vw,3.2rem)] text-[#1F4D2E] leading-[1.1] tracking-[-0.025em] mb-4">Política de Cookies</h1>
          <p className="font-karla text-[#6D8F7A] mb-10">Última actualización: Marzo 2026</p>
