-- Actualizar función para manejar reembolsos (sesiones individuales y paquetes)
...
BEGIN
  ...
  IF _deferred_id IS NULL THEN
    RAISE NOTICE 'No se encontró ingreso diferido para appointment_id: %, subscription_id: %', _appointment_id, _subscription_id;
    RETURN;
  END IF;
